...
ArduinoNanoSerial = serial.Serial('com6',9600)    
...
#    print("T34 is " + str ( int(T34.total_seconds()*1000)))
    ...
    for ((top, right, bottom, left), name) in zip(boxes, names):
        ...
        if ( name == "Sahraei" and Labels_S[N] == "Smiling" ):
            ...
            cv2.putText(image, Text1, (left, y), cv2.FONT_HERSHEY_SIMPLEX, 0.25, (0,0, 255), 1)
            ArduinoNanoSerial.write("OK".encode())
         
        elif ( name == "Sahraei" and Labels_S[N] == "Not_Smiling" ):
            
            cv2.rectangle(image, (left, top), (right, bottom), (0, 0, 255), 1)
            y = top-15 if top - 15 > 15 else top + 15
            cv2.putText(image, Text2, (left, y), cv2.FONT_HERSHEY_SIMPLEX, 0.25, (0,255, 255), 1)
            ArduinoNanoSerial.write("NOT_OK".encode())   
            
        elif ( name == "Other" and Labels_S[N] == "Smiling" ):
            
            cv2.rectangle(image, (left, top), (right, bottom), (0, 0, 255), 1)
            y = top-15 if top - 15 > 15 else top + 15
            cv2.putText(image, Text3, (left, y), cv2.FONT_HERSHEY_SIMPLEX, 0.25, (255,0, 255), 1)
            ArduinoNanoSerial.write("NOT_OK".encode())      
            ...
            cv2.rectangle(image, (left, top), (right, bottom), (0, 0, 255), 1)
            y = top-15 if top - 15 > 15 else top + 15
            cv2.putText(image, Text4, (left, y), cv2.FONT_HERSHEY_SIMPLEX, 0.25, (255,255,0), 1)
            ArduinoNanoSerial.write("NOT_OK".encode())  
...
#    	    cv2.rectangle(image, (left, top), (right, bottom), (0, 0, 255), 1)
#    	    y = top - 15 if top - 15 > 15 else top + 15
#    	    cv2.putText(image, Text2, (left, y), cv2.FONT_HERSHEY_SIMPLEX, 0.25, (0, 255, 0), 1)
#            
#            
#        elif ( name == "Other" and Labels_S[N] == "Smiling" ):   
#         	
...
#        	    cv2.rectangle(image, (left, top), (right, bottom), (0, 0, 255), 1)
#        	    y = top - 15 if top - 15 > 15 else top + 15
#        	    cv2.putText(image, Text4, (left, y), cv2.FONT_HERSHEY_SIMPLEX, 0.25, (255, 0, 0), 1)  
